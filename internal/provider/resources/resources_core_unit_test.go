...
func TestUnitCoreResources(t *testing.T) {
	mockClient := &client.MockClient{
		...
		GetTagProviderFunc: func(ctx context.Context, name string) (*client.ResourceResponse[client.TagProviderConfig], error) {
			return &client.ResourceResponse[client.TagProviderConfig]{Name: name, Signature: "sig", Enabled: base.BoolPtr(true), Config: client.TagProviderConfig{Type: "standard"}}, nil
		},
